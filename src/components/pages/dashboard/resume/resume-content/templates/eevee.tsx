...
export const Eevee = ({ data }: BaseResumeProps) => {
  ...
  return (
    <div className="w-full h-full flex">
      <section className="flex-1 p-5 min-w-[66.66%] flex flex-col">
      ...
      <aside className="p-5 w-1/3 flex-shrink-0 h-full bg-(var:--resume-primary) text-white [&_hr]:border-white">
