            ...
            {allTemplates.map((template) => {
              ...
              return (
                <button
                  ...
                  className={cn(
                    "w-full aspect-auto relative rounded border-2 border-muted overflow-hidden",
                ...
                >
                  ...
                  <div
                    className={cn(
                      "absolute text-sm inset-0 w-full h-full flex flex-col font-bold font-(family-name:--font-title) capitalize",
